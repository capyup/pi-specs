...
When a user steers behavior mid-workflow, update `PRODUCT.md` first when behavior changes, then `TECH.md`, then `TASKS.md`, then implementation and tests as needed.
